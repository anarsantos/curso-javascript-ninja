(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Fernando'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'paulista')); //caso tenha mais de um lugar o "g" vai trocar
    ...
    */
    ...
    //console.log(text.replace(/[Aa]/g, 4)); //com uma lista
    console.log(text.replace(/a/gi, 4)); //o "i" ignore case - ignora maiúscula e minúscula, poderia ser "A".
    ...
    */
    ...
    var regexDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/g;//para pegar o número dinamicamente colocar "d"
