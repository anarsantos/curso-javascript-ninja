...
*/
var championship = 'Campeonato Furada';
...
desafio.
*/
var teams = ['Gramado Verde', 'Chuteirão', 'Uniforme Novo', 'Esporte Clube Azul', 'Fundão'];
...
function showTeamPosition(posicaoTime) {
    //condição para retornar os 5 primeiros times
    if(posicaoTime < 1 || posicaoTime > 5) {
        return 'Não temos a informação do time que está nessa posição.'
    }
    return 'O time que esta em ' + posicaoTime + 'º lugar é o ' + teams[posicaoTime - 1] + '.';
}
