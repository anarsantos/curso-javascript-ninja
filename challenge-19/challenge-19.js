(function () {
    ...
    */
    ...
    var justNumbersRegex = new RegExp('^\\d+', 'gm'); //"d+" = um número ou mais
    ...
    */
    ...
    function hasClass(markup, cssClass) {
        //var regex = new RegExp('class=["\'](?:[\\w\\s]+)?' + cssClass + '(?:[\\w\\s]+)?["\']'); //não pode ser usada regex literal pq vai precisar usar a classe dentro da função. "([\w\s]+)?" = palavra ou espaço.
        var regex = new RegExp('class=["\'].*' + cssClass + '.*["\']'); //.* = qualquer caractere
