(function () {
  ...
  */
  ...
  contexto da função (é o this). Use um console.log por pessoa.
  */
  console.log('O nome das pessoas é:');
  function getFullName() {
    return this.name + ' ' + this.lastName;
  }
  console.log(getFullName.call(fernando)); //fernando foi passado como contexto da função através do método call
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call(arguments, function(accumulated, actualItem) {
      //return Number(accumulated) + Number(actualItem); //Number é construtor de números sem utilizar o new
      return +accumulated + +actualItem; //o "+" na frente do parâmetro é para converter p/ número
    });
  }
