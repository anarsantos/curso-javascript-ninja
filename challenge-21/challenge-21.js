(function (win, doc) {
   ...
   function startTimer() {
    $timer.value = +$timer.value + 1; //operador + usado c/o unário, usado antes de 1 string e ela contém valor numérico, o JS converte automaticamente converte a string em num
