...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é Carla Silva!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); // Eu peso 52 kg.
...
// Agora, apresente-se ;)
pessoa.apresentação(); // Olá, eu sou a Carla Silva, tenho 23 anos, 1.65m, meu peso é 52kg, e só hoje, eu já caminhei 90 metros!
```
